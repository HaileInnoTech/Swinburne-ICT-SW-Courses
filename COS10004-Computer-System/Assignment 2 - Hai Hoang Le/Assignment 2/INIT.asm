...
INIT:
        ...
        numarray1:
                dw  5, 3, 2, 2, 3, 4, 5    ; you can change the values here
        ...
        align 2    ; this should not need changing
        numarray2:
                dw 4, 2, 2, 3, 3, 1, 5    ; you can change the values here


        mov r8, 7  ; size of both arrays defined above
        bx lr